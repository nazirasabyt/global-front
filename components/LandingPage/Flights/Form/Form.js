...
// import "react-date-range/dist/theme/default.css";
// import { useRouter } from "next/router";
// import fetcher, { addOrUpdateItem } from "../../../../utils/helpers";
// import { HiUsers } from "react-icons/hi";
...
//             airline: item.attributes.airline,
//             to: item.attributes.to,
//             time: item.attributes.time,
//             codeFrom: item.attributes.codeFrom,
//             codeTo: item.attributes.codeTo,
...
//     const fromCity = flights.filter((item) => {
//       return item.from.toLowerCase().includes(value.toLowerCase());
//     });

//     const toCity = flights.filter((item) => {
//       return item.to.toLowerCase().includes(value.toLowerCase());
//     });

//     if (name === "from") {
//       setCitiesList({ ...citiesList, from: true });
//       setFromCitiesData(fromCity);
//     }
//     if (name === "to") {
//       const res = toCity.filter((item) => item.from == fromCitiesData[0].from);
